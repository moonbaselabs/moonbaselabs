      ...
      <div class="bg-gradient-to-r from-blue-600 to-blue-500 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
        <div class="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
          <div class="lg:self-center">
            ...
            <a href="/case-studies" class="mt-8 bg-silver-500 border border-transparent rounded-md shadow px-6 py-3 inline-flex items-center text-base font-medium text-blue-600 hover:text-blue-500 hover:bg-white transition duration-150 ease-in-out">Case Studies</a>
          </div>
        </div>

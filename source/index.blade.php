...
@section('content')
<div class="relative -mb-6 bg-gradient-to-r from-onyx-400 overflow-hidden">
  <div class="hidden sm:block sm:absolute sm:inset-y-0 sm:h-full sm:w-full">
    ...
    <svg class="absolute top-0 left-0 w-full h-64 -mt-32 text-onyx-500 lg:-mt-24" fill="currentColor" preserveAspectRatio="false" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="50%" cy="25%" rx="58%" ry="75%"></ellipse>
    </svg>
    <svg class="hidden absolute bottom-0 left-0 w-full h-64 -mb-20 text-onyx-500 md:block" fill="currentColor" preserveAspectRatio="false" xmlns="http://www.w3.org/2000/svg">
